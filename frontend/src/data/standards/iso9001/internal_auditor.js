    ...
    "questions": [
        ...
        },
        {
            ...
            "options": [
                ...
                {
                    "text": "Clause 8.2.2 Determining requirements for products",
                    "correct": false
                }
            ],
        ...
        },
        {
            ...
            "options": [
                {
                    "text": "Evaluating performance based on their ability to provide processes or products in accordance with requirements",
                    "correct": true
                },
                {
                    "text": "Ensuring externally provided processes remain within the control of the QMS",
                    "correct": false
                },
                {
                    "text": "Communicating requirements for competence to external providers",
                    "correct": false
                },
                {
                    "text": "Verifying that the external provider's premises are audited",
                    "correct": false
                }
            ],
        ...
        },
        {
            ...
            "options": [
                {
                    "text": "Reviewing the effectiveness of any corrective action taken",
                    "correct": true
                },
                {
                    "text": "Evaluating the need for action to eliminate root causes",
                    "correct": false
                },
                {
                    "text": "Updating risks and opportunities determined during planning",
                    "correct": false
                },
                {
                    "text": "Making changes to the quality management system",
                    "correct": false
                }
            ],
        ...
        },
        {
            ...
            "options": [
                {
                    "text": "Clause 6.3 Planning of changes",
                    "correct": true
                },
                {
                ...
                {
                    "text": "Clause 4.4 Quality management system and its processes",
                    "correct": false
                }
            ],
        ...
        },
        {
            ...
            "tool_data": {
                "items": [
                    {
                        "id": "i1",
                        "text": "Obsolete Rev B Blueprint used on floor",
                        "category": "Clause 7.5 Documented Information"
                    },
                    {
                        "id": "i2",
                        "text": "No records of Design Reviews",
                        "category": "Clause 8.3 Design & Development"
                    },
                    {
                        "id": "i3",
                        "text": "ERP software changed without planning",
                        "category": "Clause 6.3 Planning of Changes"
                    },
                    {
                        "id": "i4",
                        "text": "Supplier retained A-rating despite bad batches",
                        "category": "Clause 8.4 External Providers"
                    }
                ],
                "categories": [
                ...
                "levels": [
                    {
                        ...
                        "options": [
                            "The NCR was closed immediately after training.",
                            "The heat treatment furnace broke down.",
                    ...
                    },
                    {
                        ...
                        "options": [
                            "Management believed training was a foolproof solution.",
                            "The ERP system automatically closes NCRs.",
                            "The parts were reworked."
                        ],
                    ...
                    },
                    {
                        ...
                        "options": [
                            "They failed to differentiate between immediate correction and root cause elimination.",
                            "They used an obsolete blueprint.",
                            "The supplier had an 'A' rating."
                        ],
        ...
        },
        {
            ...
            "type": "true_false",
            "exhibit_ref": "audit_story",
            "text": "True or False: The finding in Paragraph 5 demonstrates a failure of Top Management to promote risk-based thinking.",
            "options": [
                {
                    "text": "True",
                    "correct": true
        ...
        },
        {
            ...
            "type": "true_false",
            "exhibit_ref": "audit_story",
            "text": "True or False: The finding in Paragraph 6 demonstrates a failure of Top Management to promote risk-based thinking.",
            "options": [
                {
                    "text": "True",
                    "correct": true
        ...
        },
        {
            ...
            "type": "true_false",
            "exhibit_ref": "audit_story",
            "text": "True or False: The finding in Paragraph 7 demonstrates a failure of Top Management to promote risk-based thinking.",
            "options": [
                {
                    "text": "True",
                    "correct": true
        ...
        },
        {
            ...
            "type": "true_false",
            "exhibit_ref": "audit_story",
            "text": "True or False: The finding in Paragraph 8 demonstrates a failure of Top Management to promote risk-based thinking.",
            "options": [
                {
                    "text": "True",
                    "correct": true
        ...
        },
        {
            ...
            "options": [
                {
                    "text": "Requirements for the products and services",
                    "correct": true
                },
                {
                    "text": "Marketing budget for the product",
                    "correct": false
                },
                {
                    "text": "Geographic location of the customer base",
                    "correct": false
                },
                {
                    "text": "Competitor pricing models",
                    "correct": false
                }
            ],
        ...
        },
        {
            ...
            "options": [
                {
                    "text": "Statutory and regulatory requirements are defined",
                    "correct": true
                },
                {
                    "text": "The price is competitive",
                    "correct": false
                },
                {
                    "text": "The delivery time is shorter than competitors",
                    "correct": false
                },
                {
                    "text": "The product is designed internally",
                    "correct": false
                }
            ],
        ...
        },
        {
            ...
            "options": [
                {
                    "text": "The nature, duration and complexity of the design and development activities",
                    "correct": true
                },
                {
                    "text": "The color of the final product packaging",
                    "correct": false
                },
                {
                    "text": "The salaries of the design engineers",
                    "correct": false
                },
                {
                    "text": "The marketing strategy for the new product",
                    "correct": false
                }
            ],
        ...
        },
        {
            ...
            "options": [
                {
                    "text": "Determine and apply criteria for the evaluation, selection, performance monitoring, and re-evaluation",
                    "correct": true
                },
                {
                    "text": "Ensure external providers are ISO 9001 certified",
                    "correct": false
                },
                {
                    "text": "Audit every external provider on-site annually",
                    "correct": false
                },
                {
                    "text": "Select the external provider with the lowest price",
                    "correct": false
                }
            ],
        ...
        },
        {
            ...
            "tool_data": {
                ...
                "findings_pool": [
                    {
                        "id": "o1",
                        "evidence": "Documented information defining product characteristics is available.",
                        "correct_classification": "Conforming",
                        "correct_clause": "Conforming"
                    },
                    {
                        "id": "o2",
                        "evidence": "Measuring equipment is unavailable at the point of use.",
                        "correct_classification": "Nonconforming",
                        "correct_clause": "Nonconforming"
                    },
                    {
                        "id": "o3",
                        "evidence": "Competent persons are appointed, including any required qualification.",
                        "correct_classification": "Conforming",
                        "correct_clause": "Conforming"
                    },
                    {
                        "id": "o4",
                        "evidence": "Validation of special processes is skipped to save time.",
                        "correct_classification": "Nonconforming",
                        "correct_clause": "Nonconforming"
                    }
                ]
        ...
        },
        {
            ...
            "options": [
                {
                    "text": "Control the unique identification of the outputs and retain documented information",
                    "correct": true
                },
                {
                    "text": "Ensure the product has a barcode",
                    "correct": false
                },
                {
                    "text": "Hire a third-party logistics company",
                    "correct": false
                },
                {
                    "text": "Engrave the company logo on all products",
                    "correct": false
                }
            ],
        ...
        },
        {
            ...
            "options": [
                {
                    "text": "Establishing the initial product design",
                    "correct": true
                },
                {
                    "text": "Handling and contamination control",
                    "correct": false
                },
                {
                ...
                {
                    "text": "Transmission or transportation",
                    "correct": false
                }
            ],
        ...
        },
        {
            ...
            "options": [
                {
                    "text": "Otherwise approved by a relevant authority and, as applicable, by the customer",
                    "correct": true
                },
                {
                    "text": "The production deadline is missed",
                    "correct": false
                },
                {
                    "text": "The quality manager is on vacation",
                    "correct": false
                },
                {
                    "text": "The product is non-critical",
                    "correct": false
                }
            ],
        ...
        },
        {
            ...
            "tool_data": {
                "steps": [
                    {
                        "id": "s1",
                        "text": "Identify and isolate the nonconforming output"
                    },
                    {
                        "id": "s2",
                        "text": "Take appropriate action (correction, segregation, etc.)"
                    },
                    {
                        "id": "s3",
                        "text": "Obtain authorization for acceptance under concession (if applicable)"
                    },
                    {
                        "id": "s4",
                        "text": "Verify conformity to requirements when output is corrected"
                    }
                ]
            },
            "expected_payload": "evaluated_at_runtime",
        ...
        },
        {
            ...
            "options": [
                {
                    "text": "The nonconformity, actions taken, concessions obtained, and authority deciding the action",
                    "correct": true
                },
                {
                    "text": "Only the financial cost of the scrap",
                    "correct": false
                },
                {
                    "text": "The names of the operators who caused the error",
                    "correct": false
                },
                {
                    "text": "A photograph of every nonconforming item",
                    "correct": false
                }
            ],
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "Regarding QMS planning (Question 1), what is a primary requirement when addressing risks and opportunities?",
            "options": [
                {
                    "text": "Plan actions to address these risks and opportunities",
                    "correct": true
                },
                {
                    "text": "Eliminate all risks immediately",
                    "correct": false
                },
                {
                    "text": "Outsource all risky processes",
                    "correct": false
                },
                {
                    "text": "Purchase expensive insurance",
                    "correct": false
                }
            ],
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "Regarding QMS planning (Question 2), what is a primary requirement when addressing risks and opportunities?",
            "options": [
                {
                    "text": "Plan actions to address these risks and opportunities",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "Regarding QMS planning (Question 3), what is a primary requirement when addressing risks and opportunities?",
            "options": [
                {
                    "text": "Plan actions to address these risks and opportunities",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "Regarding QMS planning (Question 4), what is a primary requirement when addressing risks and opportunities?",
            "options": [
                {
                    "text": "Plan actions to address these risks and opportunities",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "Regarding QMS planning (Question 5), what is a primary requirement when addressing risks and opportunities?",
            "options": [
                {
                    "text": "Plan actions to address these risks and opportunities",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "Regarding QMS planning (Question 6), what is a primary requirement when addressing risks and opportunities?",
            "options": [
                {
                    "text": "Plan actions to address these risks and opportunities",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "Regarding QMS planning (Question 7), what is a primary requirement when addressing risks and opportunities?",
            "options": [
                {
                    "text": "Plan actions to address these risks and opportunities",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "Regarding QMS planning (Question 8), what is a primary requirement when addressing risks and opportunities?",
            "options": [
                {
                    "text": "Plan actions to address these risks and opportunities",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "Regarding QMS planning (Question 9), what is a primary requirement when addressing risks and opportunities?",
            "options": [
                {
                    "text": "Plan actions to address these risks and opportunities",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "Regarding QMS planning (Question 10), what is a primary requirement when addressing risks and opportunities?",
            "options": [
                {
                    "text": "Plan actions to address these risks and opportunities",
                    "correct": true
        ...
        },
        {
            ...
            "type": "true_false",
            "exhibit_ref": "none",
            "text": "True or False: Clause 7.1.6 requires organizations to determine the knowledge necessary for the operation of its processes.",
            "options": [
                {
                    "text": "True",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "What is a mandatory input for the Management Review under Clause 9.3 (Test 1)?",
            "options": [
                {
                    "text": "Information on the performance and effectiveness of the QMS, including customer satisfaction",
                    "correct": true
                },
                {
                    "text": "The payroll details of the audit team",
                    "correct": false
                },
                {
                    "text": "Competitor marketing strategies",
                    "correct": false
                },
                {
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "What is a mandatory input for the Management Review under Clause 9.3 (Test 2)?",
            "options": [
                {
                    "text": "Information on the performance and effectiveness of the QMS, including customer satisfaction",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "What is a mandatory input for the Management Review under Clause 9.3 (Test 3)?",
            "options": [
                {
                    "text": "Information on the performance and effectiveness of the QMS, including customer satisfaction",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "What is a mandatory input for the Management Review under Clause 9.3 (Test 4)?",
            "options": [
                {
                    "text": "Information on the performance and effectiveness of the QMS, including customer satisfaction",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "What is a mandatory input for the Management Review under Clause 9.3 (Test 5)?",
            "options": [
                {
                    "text": "Information on the performance and effectiveness of the QMS, including customer satisfaction",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "What is a mandatory input for the Management Review under Clause 9.3 (Test 6)?",
            "options": [
                {
                    "text": "Information on the performance and effectiveness of the QMS, including customer satisfaction",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "What is a mandatory input for the Management Review under Clause 9.3 (Test 7)?",
            "options": [
                {
                    "text": "Information on the performance and effectiveness of the QMS, including customer satisfaction",
                    "correct": true
        ...
        },
        {
            ...
            "type": "single_select",
            "exhibit_ref": "none",
            "text": "What is a mandatory input for the Management Review under Clause 9.3 (Test 8)?",
            "options": [
                {
                    "text": "Information on the performance and effectiveness of the QMS, including customer satisfaction",
                    "correct": true
        ...
        },
        {
            ...
            "type": "true_false",
            "exhibit_ref": "none",
            "text": "True or False: Continual improvement under Clause 10.3 requires improving the suitability, adequacy, and effectiveness of the QMS.",
            "options": [
                {
                    "text": "True",
                    "correct": true
